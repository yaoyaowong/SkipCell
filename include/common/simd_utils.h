#ifndef COMMON_SIMD_UTILS
#define COMMON_SIMD_UTILS
...
static inline __m256 _mm256_mul_epi8(__m256i X) {
  ...
  return _mm256_cvtepi32_ps(
      _mm256_add_epi32(_mm256_madd_epi16(xlo, xlo), _mm256_madd_epi16(xhi, xhi)));
}
#endif
...
static inline __m256 _mm256_mul_epi8(__m256i X, __m256i Y) {
  ...
  return _mm256_cvtepi32_ps(
      _mm256_add_epi32(_mm256_madd_epi16(xlo, ylo), _mm256_madd_epi16(xhi, yhi)));
}
